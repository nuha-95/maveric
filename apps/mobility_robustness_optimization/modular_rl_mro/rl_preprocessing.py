...
# Import from simple MRO utils
sys.path.insert(0, os.path.join(maveric_root, 'apps', 'mobility_robustness_optimization', 'modular_simple_mro'))
from mro_utils import predictions, preprocess_simulation_data


def preprocess_rl_mro(mobility_model_params, topology, bdt_model_path, new_data=None):
    """Preprocess simulation data for RL MRO using trained BDT models."""
